...
var
    ...
    baron.fn = {
        ...
        baron: function(params) {
	        ...
	        params.support = ["Win", "Mac", "linux", "mobile"];
    ...
    function manageEvents(item, eventManager, mode) {
	    ...
	    console.log("function manageEvents", item, eventManager, mode);
    ...
    function manageAttr(node, direction, mode) {
	    ...
	    console.log("function manageAttr", node, direction, mode);
    ...
    function init(params) {
	    ...
	    console.log("function init", params);
    ...
    function clone(input) {
	    ...
	    console.log("ffunction clone", input);
    ...
    function validate(input) {
	    ...
	    console.log("function validate", input);
    ...
    function fire(eventName) {
	    ...
	    console.log("function fire", eventName);
